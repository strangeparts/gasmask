...
## Safety Warnings
1. Print Material: PLA can be brittle and sharp in the event that it breaks. Please consider using PETG or Nylon if this could be an issue in the environment you plan on using it - especially if you expect the mask to be subjected to impacts or otherwise stressed.
